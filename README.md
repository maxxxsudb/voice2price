...
> **Важно:** При первом запуске скрипт инициализации автоматически создаст все необходимые таблицы в базе данных. Дождитесь сообщения "✅ Инициализация завершена" в логах бэкенда.
