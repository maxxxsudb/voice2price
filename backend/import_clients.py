...
Использование:
    python import_clients.py <employee_id> <путь_к_файлу.xlsx>

Пример:
    python import_clients.py ivanov Клиенты.xlsx
"""
...
def main():
    """Главная функция"""
    if len(sys.argv) < 3:
        print("Использование: python import_clients.py <employee_id> <путь_к_файлу.xlsx>")
        print()
        print("Пример:")
        print("  python import_clients.py ivanov Клиенты.xlsx")
        sys.exit(1)
